/**
 * Script to fix syntax errors in the variant-90 Component file
 */
...
const fixFile = async () => {
  const filePath = path.join(__dirname, '..', 'src/components/review/question-view-variants/variant-90/Component.tsx');
