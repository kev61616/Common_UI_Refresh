    ...
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
      <div className="p-5 border-b border-slate-200 dark:border-slate-700">
        <div className="flex items-center justify-between">
          <h3 className="font-medium text-slate-800 dark:text-white text-lg">Score Projection</h3>
      ...
      <div className="p-5">
        ...
        <div className="mt-6 grid grid-cols-3 gap-4">
          <div className="bg-slate-50 dark:bg-slate-700/30 rounded-lg p-4">
            ...
            <div className={`mt-1 text-2xl font-semibold ${getScoreColor(scoreData[scoreData.length - 1]?.score || 0)}`}>
          ...
          <div className="bg-slate-50 dark:bg-slate-700/30 rounded-lg p-4">
            ...
            <div className={`mt-1 text-2xl font-semibold ${improvementRate >= 0 ? 'text-emerald-500 dark:text-emerald-400' : 'text-rose-500 dark:text-rose-400'}`}>
          ...
          <div className="bg-slate-50 dark:bg-slate-700/30 rounded-lg p-4">
            <div className="text-sm text-slate-500 dark:text-slate-400">Projected Score</div>
            <div className={`mt-1 text-2xl font-semibold ${getScoreColor(projections[projections.length - 1].score)}`}>
          ...
          <ul className="space-y-2">
            {improvementRate < 0 && (
              <li className="flex items-start text-sm text-slate-600 dark:text-slate-400">
                <svg className="h-5 w-5 text-rose-500 dark:text-rose-400 mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
