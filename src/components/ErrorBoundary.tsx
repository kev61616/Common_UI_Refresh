...
export class ErrorBoundary extends Component<Props, State> {
  ...
  render(): ReactNode {
    if (this.state.hasError) {
      ...
      return (
        <div className="p-6 rounded-lg border border-red-300 bg-red-50 dark:bg-red-900/20 dark:border-red-800">
          ...
          <details className="mt-4">
            ...
            <pre className="mt-2 p-4 bg-slate-800 text-white rounded overflow-x-auto text-xs">
