...
export function WarningIcon({
  ...
  return (
    <>
      <defs data-oid="hwf_mf5">
        <Gradient
          id={`${id}-gradient`}
          color={color}
          gradientTransform="rotate(65.924 1.519 20.92) scale(25.7391)" data-oid=":w2_dpt" />

        <Gradient
          id={`${id}-gradient-dark`}
          color={color}
          gradientTransform="matrix(0 24.5 -24.5 0 16 5.5)" data-oid="svao_48" />

      </defs>
      <LightMode data-oid="l.hv1b1">
        <circle cx={20} cy={20} r={12} fill={`url(#${id}-gradient)`} data-oid="gtlcip:" />
        <path
          ...
          strokeWidth={2}
          strokeLinecap="round"
          strokeLinejoin="round" data-oid="vhrj91n" />
        ...
        <path
          ...
          strokeWidth={2}
          strokeLinecap="round"
          strokeLinejoin="round" data-oid="30:cwy6" />
        ...
        <path
          ...
          strokeWidth={2}
          strokeLinecap="round"
          strokeLinejoin="round" data-oid="esd67pn" />

      </LightMode>
      <DarkMode data-oid="-.v3r_2">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          ...
          fill={`url(#${id}-gradient-dark)`} data-oid=".9mtwvz" />
