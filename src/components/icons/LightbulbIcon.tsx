...
export function LightbulbIcon({
  ...
  return (
    <>
      <defs data-oid="-f8mc:s">
        <Gradient
          id={`${id}-gradient`}
          color={color}
          gradientTransform="matrix(0 21 -21 0 20 11)" data-oid="38m9jtw" />

        <Gradient
          id={`${id}-gradient-dark`}
          color={color}
          gradientTransform="matrix(0 24.5001 -19.2498 0 16 5.5)" data-oid="sig6ojj" />

      </defs>
      <LightMode data-oid="nwfa:49">
        <circle cx={20} cy={20} r={12} fill={`url(#${id}-gradient)`} data-oid="ky02tly" />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
        ...
        <path
          ...
          className="fill-[var(--icon-foreground)]" data-oid="c:5q92:" />

      </LightMode>
      <DarkMode data-oid="b:k5wt6">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          ...
          fill={`url(#${id}-gradient-dark)`} data-oid=":157kau" />
