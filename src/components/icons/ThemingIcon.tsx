...
export function ThemingIcon({
  ...
  return (
    <>
      <defs data-oid="gcmqb9r">
        <Gradient
          id={`${id}-gradient`}
          color={color}
          gradientTransform="matrix(0 21 -21 0 12 11)" data-oid="21ntlc-" />

        <Gradient
          id={`${id}-gradient-dark`}
          color={color}
          gradientTransform="matrix(0 24.5 -24.5 0 16 5.5)" data-oid="62y.cr7" />

      </defs>
      <LightMode data-oid="3cgjs.e">
        <circle cx={12} cy={20} r={12} fill={`url(#${id}-gradient)`} data-oid="qdhaxbj" />
        <path
          ...
          strokeWidth={2}
          strokeLinecap="round"
          strokeLinejoin="round" data-oid="gt6h9_7" />

        <path
          d="M3 3h10v22a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4V3Z"
          className="fill-[var(--icon-background)]"
          fillOpacity={0.5} data-oid="xtksod2" />
        ...
        <path
          ...
          strokeWidth={2}
          strokeLinecap="round"
          strokeLinejoin="round" data-oid="1q43ji9" />
        ...
        <path
          ...
          strokeWidth={2}
          strokeLinecap="round"
          strokeLinejoin="round" data-oid="xs5jiab" />

      </LightMode>
      <DarkMode data-oid="v8-lu-0">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          ...
          fill={`url(#${id}-gradient-dark)`} data-oid="awng:cj" />
