  ...
  return (
    <Headless.Combobox {...props} multiple={false} virtual={{ options: filteredOptions }} onClose={() => setQuery('')}>
      ...
      >
        <Headless.ComboboxInput
          ...
          className={clsx([
            className,
            // Basic layout
            'relative block w-full appearance-none rounded-lg py-2.5 sm:py-1.5', // Adjusted padding using standard classes
            // Horizontal padding
            'pr-10 pl-3.5 sm:pr-9 sm:pl-3', // Using standard tailwind spacing classes
            // Typography
      ...
      <Headless.ComboboxOptions
        ...
        anchor={anchor}
        className={clsx(
          // Anchor positioning - Restored and uses literal values
      ...
      >
        {/* Assert option type as Headless UI provides 'unknown' */}
...
>) {
  ...
  return (
    <Headless.ComboboxOption
      {...props}
      className={clsx(
        // Basic layout - Replace --spacing() with actual rem values
