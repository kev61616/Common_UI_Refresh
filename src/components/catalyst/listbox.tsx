  ...
  return (
    <Headless.Listbox {...props} multiple={false}>
      ...
      >
        <Headless.ListboxSelectedOption
          ...
          className={clsx([
            ...
            'min-h-11 sm:min-h-9',
            // Horizontal padding
            'pr-7 pl-3.5 sm:pl-3', // Using standard tailwind spacing classes
            // Typography
      ...
      <Headless.ListboxOptions
        ...
        className={clsx(
          // Anchor positioning
          '[--anchor-offset:-1.625rem] [--anchor-padding:var(--spacing-4)] sm:[--anchor-offset:-1.375rem]', // Use spacing var if defined
          // Base styles
