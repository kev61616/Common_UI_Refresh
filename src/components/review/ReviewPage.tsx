...
export function ReviewPage({
  ...
  return (
    <div className="pb-8 rounded-xl mx-auto max-w-6xl" data-oid="ou:gwr-">
      ...
      <div
        ...
        style={{ top: 'var(--navbar-height, 4.75rem)' }} data-oid="c7ftbu3">

        <div className="pb-0 space-y-2 min-h-[8rem]" data-oid="p4dnt.4">
          {/* View toggle - updated to match the style of Question View tabs */}
          <div className="flex flex-wrap gap-2 md:gap-3 pb-0 px-1" data-oid="nutmhtl">
            <button
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 md:h-5 md:w-5 mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-oid="z-9gxk9">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 10h16M4 14h16M4 18h16" data-oid="xf.jkes" />
              </svg>
              <span className="hidden sm:inline" data-oid="h0mz:it">Set View</span>
              <span className="sm:hidden" data-oid=":.0q_n.">Sets</span>
            </button>
            <button
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 md:h-5 md:w-5 mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-oid="ni164.h">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" data-oid="5gsuffs" />
              </svg>
              <span className="hidden sm:inline" data-oid="d1:34f3">Question View</span>
              <span className="sm:hidden" data-oid=".6uig.d">Questions</span>
            </button>
            <button
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 md:h-5 md:w-5 mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-oid="881qz6o">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" data-oid="r2_a4az" />
              </svg>
              <span className="hidden sm:inline" data-oid="92-7_sl">Kanban View</span>
              <span className="sm:hidden" data-oid="3jf76if">Kanban</span>
            </button>
            
            {/* Mobile filter toggle */}
            <div className="flex-grow flex justify-end md:hidden" data-oid="zygdf4v">
              <button
                onClick={() => setShowMobileFilters(!showMobileFilters)}
                className="px-3 py-2 text-sm font-medium bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-md transition-colors flex items-center gap-2 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700" data-oid="3ac3z3v">

                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-oid="q4jr11w">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" data-oid="ooamsx9" />
                </svg>
                Filters
                ...
                <span className="ml-1 w-5 h-5 flex items-center justify-center bg-sky-500 text-white text-xs rounded-full" data-oid="y.l_yb7">
          ...
          <div className={`${showMobileFilters ? 'block' : 'hidden md:block'} px-1`} data-oid="3guws6z">
            <div className="mb-0" data-oid="cf.3_zj">
              <ModularFilterBar
                initialFilters={filters}
                onFilterChange={handleFilterChange}
                onClearFilters={handleClearFilters}
                onFiltersApplied={handleApplyFilters} data-oid="ujlnld-" />
      ...
      <div className="mt-4 w-full" data-oid=".a7duak">
        {/* Use ErrorBoundary to catch and display errors */}
        {viewType === 'set' ?
        <SetViewTable
          practiceSets={filteredSets}
          onSelectSet={handleSelectSet}
          selectedSetId={selectedSetId} data-oid="ihcc.w7" /> :

        viewType === 'kanban' ?
        <ErrorBoundary data-oid="d5g6ngd">
            <CollapsibleKanbanView
            practiceSets={filteredSets}
            onSelectSet={handleSelectSet}
            selectedSetId={selectedSetId}
            sortConfig={sortConfig}
            onSortChange={handleSortChange} data-oid="myl8c:0" />

          </ErrorBoundary> :

        <ErrorBoundary data-oid="y33myu:">
            <QuestionViewTabs
            practiceSets={filteredSets}
            onSelectSet={handleSelectSet}
            selectedSetId={selectedSetId}
            sortConfig={sortConfig}
            onSortChange={handleSortChange} data-oid="z24il0v" />
      ...
      <div
        ...
        <div className="absolute top-0 left-0 w-[3px] h-full bg-gradient-to-b from-sky-500 via-indigo-500 to-purple-500 opacity-80" data-oid="hno9.70"></div>
        ...
        <button
          ...
          aria-label="Close panel" data-oid="hz0gzqa">

          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" data-oid="qwkcki2">
            <path fillRule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clipRule="evenodd" data-oid="cz29hmr" />
          </svg>
        </button>
        
        {/* Actual panel content */}
        <div className="h-full overflow-y-auto" data-oid="55o6bph">
          {selectedSet && <AnalyticsPanel practiceSet={selectedSet} data-oid="8if73g_" />}
        </div>
      </div>
      ...
      <div
        ...
        onClick={handleClosePanel} data-oid="hi3dpu9">
      </div>
      }
    </div>);
