...
export function EnhancedCollapsibleKanbanView({
  ...
  return (
    <div className="pb-8 px-4" data-oid="-b1yl_u">
      {/* Title Section */}
      <div className="text-center mb-8 px-0" data-oid=".:ct4e8">
        <h2 className="text-2xl font-bold text-slate-800 dark:text-white mb-2" data-oid="vd:z0dc">
          Skill Mastery Progression
        </h2>
        <p className="text-sm text-slate-500 dark:text-slate-400 max-w-2xl mx-auto" data-oid=".ujs4i5">
      ...
      {/* Kanban board layout */}
      <div className="w-full h-full" data-oid="9k.hgev">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pb-4" data-oid="668sv32">
          {masteryLevels.map((level) => {
            ...
            return (
              <div
                key={level.id}
                className={`${level.color} border ${level.borderColor} rounded-lg shadow-sm overflow-hidden hover:shadow-md hover:scale-[1.02] hover:z-10 transition-all duration-300`} data-oid="8qgu-0q">
                ...
                <div
                  ...
                  <div className="flex items-center gap-3" data-oid="nvvto13">
                    <div className={`${level.iconBg} text-white p-1.5 rounded-lg`} data-oid="rv1t1d7">
                      <SwordIcon size={16} color="white" data-oid="2aikgyf" />
                    </div>
                    <div data-oid="vu2a_j5">
                      <h3 className={`font-semibold ${level.titleColor}`} data-oid="lp_musy">{level.name}</h3>
                      <div className="text-xs text-slate-600 dark:text-slate-400" data-oid=".z-fkq8">{level.description}</div>
                    </div>
                  </div>
                  
                  <div className="flex items-center gap-2" data-oid="5i2-pl2">
                    <ClientOnlyCount count={questionCount} data-oid="j3stj6s" />
                    <button
                      className="text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 transition-colors"
                      disabled={isAnyCardFocused} data-oid="9deefrp">

                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className={`h-5 w-5 transition-transform duration-300 ${isExpanded ? 'transform rotate-180' : ''}`}
                        viewBox="0 0 20 20"
                        fill="currentColor" data-oid="a8a1oli">

                        <path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd" data-oid="5qhkgwd" />
                      </svg>
                    </button>
                  </div>
                </div>
                ...
                <div className="p-3 max-h-[150px] relative overflow-hidden" data-oid="qqnox-0">

                  {/* Stacked card preview */}
                  <div className="relative h-[120px]" data-oid="7rqr.-y">
                    ...
                    <div
                      ...
                      onClick={(e) => {
                        ...
                        if (!expandedColumns.includes(level.id)) {
                          ...
                          <div className="flex items-center gap-2" data-oid=":o7:._y">
                            <div className={`w-2 h-2 rounded-full ${getSubjectColor(question.setSubject)}`} data-oid="h467eqe"></div>
                            <span className="text-xs font-medium text-slate-500 dark:text-slate-400 truncate" data-oid="tpgemt2">{question.setSubject}</span>
                          </div>
                          
                          <div className="font-medium text-sm mt-1 text-slate-800 dark:text-slate-200 truncate" data-oid="ixrudv-">
                            {question.topic}
                          </div>
                          
                          {index === 0 &&
                      <div className="text-xs text-slate-600 dark:text-slate-400 mt-1 truncate" data-oid="8xgcs47">
                              {question.subtopic}
                            </div>
                      }
                        </div>
                    ...
                    <div className="absolute bottom-0 left-0 right-0 text-center text-sm font-medium text-slate-600 dark:text-slate-400 py-1" data-oid="lu041tw">
                      ...
                      {/* Empty state */}
                      {questionCount === 0 &&
                    <div className="flex flex-col items-center justify-center h-full text-center" data-oid="vo:4vte">
                          <div className="text-slate-400 dark:text-slate-500 mb-2" data-oid="01y1049">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-oid="58.3d6n">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" data-oid="azeaa1g" />
                            </svg>
                          </div>
                          <div className="text-xs text-slate-500 dark:text-slate-400" data-oid="vlpu2zb">No questions in this category</div>
                        </div>
                    }
                    </div>
                </div>
      ...
      {activePopupId &&
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4" data-oid="96u9puw">
          {/* Semi-transparent backdrop */}
          <div
          className="absolute inset-0 bg-black/40 backdrop-blur-sm transition-opacity duration-300"
          style={{ opacity: isPopupVisible ? 1 : 0 }}
          onClick={closePopup} data-oid="w8uplfz">
        </div>
          ...
          <div key={level.id} className="flex flex-col h-full" data-oid="xw39sr-">
                {/* Popup header */}
                <div className={`${level.headerBg} ${level.color} p-6 border-b ${level.borderColor}`} data-oid="u4a83sv">
                  <div className="flex justify-between items-center" data-oid="-9vc7gw">
                    <div className="flex items-center gap-4" data-oid="ucwnu2j">
                      <div className={`${level.iconBg} text-white p-3 rounded-xl`} data-oid="5j1zbqr">
                        <SwordIcon size={24} color="white" data-oid="yncx_l3" />
                      </div>
                      <div data-oid="-n-ezmx">
                        <h2 className={`text-2xl font-bold ${level.titleColor}`} data-oid="eef6wlp">{level.name}</h2>
                        <p className="text-sm text-slate-600 dark:text-slate-400" data-oid="bkoq._l">{level.description}</p>
                      </div>
                    </div>
                    
                    <button
                  onClick={closePopup}
                  className="p-2 rounded-full hover:bg-slate-200/50 dark:hover:bg-slate-700/50 transition-colors" data-oid="7qzfm1b">

                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-slate-500 dark:text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-oid="c8dc08t">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" data-oid="1-vj3qj" />
                      </svg>
                    </button>
                  </div>
                </div>
                ...
                {/* Popup content */}
                <div className="p-6 overflow-y-auto" style={{ maxHeight: 'calc(85vh - 100px)' }} data-oid="0ar5ukk">
                ...
                onSortChange={handlePopupSortChange} data-oid="tg:06ib" />

                  
                  <div className="mb-6 mt-4" data-oid="lrw05t7">
                    <h3 className="text-lg font-semibold text-slate-800 dark:text-white mb-2" data-oid=".j8rq-q">Questions in this category</h3>
                    <div className="text-sm text-slate-500 dark:text-slate-400" data-oid="3f-w76s">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4" data-oid="3hfgj7e">
                ...
                <div
                  ...
                  onClick={() => onSelectSet && onSelectSet(question.setId)} data-oid="o0vo:mx">

                        <div className="flex items-center gap-2 mb-2" data-oid="v8mul3u">
                          <div className={`w-2 h-2 rounded-full ${getSubjectColor(question.setSubject)}`} data-oid="yxvxn.g"></div>
                          <span className="text-xs font-medium text-slate-500 dark:text-slate-400" data-oid="ta1gypz">{question.setSubject}</span>
                        </div>
                        
                        <div className="font-medium text-sm mb-2 text-slate-800 dark:text-white" data-oid="aj2ixan">
                          {question.topic}
                        </div>
                        
                        <div className="text-xs text-slate-600 dark:text-slate-400 mb-3" data-oid="-2gfs-:">
                          {question.subtopic}
                        </div>
                        
                        <div className="flex justify-between items-center mt-2 pt-2 border-t border-slate-100 dark:border-slate-800" data-oid="o5_1-zu">
                  ...
                  {/* Empty state */}
                  {questionsByLevel[level.id].length === 0 &&
              <div className="flex flex-col items-center justify-center py-12 text-center" data-oid="-i.2jjf">
                      <div className="text-slate-400 dark:text-slate-500 mb-4" data-oid="whv:kbj">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-oid="9htx0m2">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" data-oid="htwrtxd" />
                        </svg>
                      </div>
                      <h3 className="text-lg font-medium text-slate-800 dark:text-white mb-2" data-oid="m2p:1z:">No questions in this category</h3>
                      <p className="text-sm text-slate-500 dark:text-slate-400 max-w-md" data-oid="klex52z">
                ...
                {/* Popup footer */}
                <div className="p-4 border-t border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50" data-oid="83ep1hx">
                  <div className="flex justify-end" data-oid="abiw0zr">
                    <button
                  onClick={closePopup}
                  className="px-4 py-2 bg-white dark:bg-slate-700 rounded-md text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-600 hover:bg-slate-100 dark:hover:bg-slate-600 transition-colors" data-oid="bpd09oy">
