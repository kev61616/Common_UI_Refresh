...
export function EnhancedCollapsibleBoardView({
  ...
  return (
    <div className="pb-8 px-4" data-oid="yzxwepx">
      {/* Title Section */}
      <BoardHeader
        title="Skill Mastery Progression"
        description="Track your journey from novice to expert across all concepts, visualizing your growth and identifying areas for improvement" data-oid="fzjrs.o" />

      
      {/* Board layout */}
      <div className="w-full h-full" data-oid="-t-p:i1">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pb-4" data-oid="ekc4z05">
          {masteryLevels.map((level) => {
            ...
            return (
              <BoardColumn
                ...
                onOpenPopup={openPopup} data-oid="c7ydrv3" />);
      ...
      <BoardPopup
        ...
        onSelectSet={onSelectSet} data-oid="deerx1k" />
