...
/**
 * CalendarTimelineView - Calendar-based timeline that displays practice sets organized by date
 * This is a renamed and reorganized version of the original TimelineView3 component
 */
export function CalendarTimelineView({ practiceSets, onSelectSet, selectedSetId }: TimelineViewProps) {
            ...
            <div className="space-y-1">
              {todaySets.length <= 3 ? (
                ...
                <div 
                  ...
                  onClick={() => {
                    if (todaySets.length > 0 && onSelectSet) onSelectSet(todaySets[0].id)
                  }}
