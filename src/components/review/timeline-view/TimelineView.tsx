...
/**
 * TimelineView - Narrative timeline that displays practice sets as a learning journey with chapters
 */
export function TimelineView({ practiceSets, onSelectSet, selectedSetId }: TimelineViewProps) {
  ...
  return (
    <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-4 shadow-sm max-w-4xl mx-auto">
