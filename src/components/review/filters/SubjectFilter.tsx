  ...
  return (
    <Dropdown
      ...
      <FilterButton
        ...
        count={filters.subject.length} data-oid="cydy2f6" />
      ...
      elevated={true}
      className={`p-2 space-y-1 w-44 ${filterColors.subject.dropdown}`} data-oid="wuwpfud">
      ...
      <button
        ...
        'text-slate-700 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-700/70'}`
          ...
          {filters.subject.includes(subject) ?
        <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5 mr-2" viewBox="0 0 20 20" fill="currentColor" data-oid="6.n657b">
              <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" data-oid="-alo55h" />
            </svg> :

        <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5 mr-2 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-oid="qfxfdhj">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" data-oid="9no3gxi" />
            </svg>
        }
          {subject}
        </button>
