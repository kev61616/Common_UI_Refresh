...
export const ErrorPatternFilter: React.FC<ErrorPatternFilterProps> = ({
  ...
  return (
    <div className="md:w-3/5" data-oid="d65q88h">
      <h3 className="text-sm font-medium text-slate-700 mb-3 dark:text-slate-300 flex items-center gap-1.5" data-oid="yy05glu">
        <ErrorPatternIcon data-oid="xg39:p:" />
        Error Pattern Detection
      </h3>
      <div className="flex flex-wrap gap-2" data-oid="66t774d">
        ...
        <button
          ...
          'bg-white text-slate-600 border-slate-200 hover:bg-slate-50 dark:bg-slate-800 dark:text-slate-300 dark:border-slate-700 dark:hover:bg-slate-700'}`
            ...
            <PatternDetectionIcon data-oid="9ltblu9" />
