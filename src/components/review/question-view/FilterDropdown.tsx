...
export const FilterDropdown: React.FC<FilterDropdownProps> = ({
  ...
  return (
    <div className="relative" ref={dropdownRef} data-oid="su:rn7n">
      {/* Filter button */}
      <button
        ...
        {label}
        {selectedCount > 0 &&
        <span className="bg-sky-200 text-sky-800 text-xs px-1.5 py-0.5 rounded-full dark:bg-sky-800 dark:text-sky-200" data-oid="a8uxvkr">
            {selectedCount}
          </span>
        }
        <svg
          ...
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor" data-oid="ifj-aix">

          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" data-oid="34a1lp9" />
        </svg>
      </button>
      
      {/* Dropdown menu */}
      {isOpen &&
      <div className="absolute top-full left-0 mt-1 w-48 rounded-md shadow-lg bg-white dark:bg-slate-800 ring-1 ring-black ring-opacity-5 z-10 overflow-hidden" data-oid="r6:r:-5">
          <div className="py-1" role="menu" aria-orientation="vertical" data-oid="63r3ma6">
            {options.map((option) => {
            ...
            return (
              <button
                ...
                onClick={() => toggleOption(option.id)} data-oid="df35bpq">
                ...
                'border-slate-300 dark:border-slate-600 group-hover:border-sky-400'}`
                    ...
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor" data-oid="scmzu19">

                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" data-oid="npi11os" />
                    </svg>
                  </div>
