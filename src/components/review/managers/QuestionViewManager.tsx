    ...
    <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-4 shadow-sm">
      ...
      <Suspense fallback={<LoadingPlaceholder />}>
        {isLoading ? (
          ...
          <ErrorBoundary fallback={<ErrorPlaceholder variant={variant} category="question" />}>
...
function LoadingPlaceholder() {
  return (
    <div className="min-h-[500px] flex justify-center items-center bg-slate-50 dark:bg-slate-800/20 rounded-lg animate-pulse">
  ...
  return (
    <div className="min-h-[500px] flex justify-center items-center bg-slate-50 dark:bg-slate-800/20 rounded-lg">
      <div className="text-center p-8 max-w-md">
        ...
        <h4 className="text-lg font-medium mb-2">View Error</h4>
        <p className="text-slate-600 dark:text-slate-400 mb-4">
          There was an error loading this view. Please try a different one.
        </p>
        <div className="text-sm text-slate-500 dark:text-slate-500 p-2 bg-slate-100 dark:bg-slate-800 rounded-md">
