...
// Based on ConceptMapView
// Leonardo da Vinci inspired concept visualization with detailed anatomical-style diagrams
 ...
 */
export function RenaissanceDiagramConceptMapView({ practiceSets, onSelectSet, selectedSetId }: QuestionViewProps) {
  ...
  return (
    <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-4 shadow-sm" data-oid="xd7lyz6">
      <h3 className="text-xl font-bold mb-6 text-center" data-oid="20mguk3">89. Renaissance Diagram Concept Map</h3>
      
      {/* Controls */}
      <div className="flex justify-between mb-6" data-oid="co9_orm">
        {/* Subject filter */}
        <div className="flex space-x-2" data-oid="d4fvly:">
          <button
        ...
        {/* Zoom controls */}
        <div className="flex items-center space-x-2" data-oid="sj6dpbp">
          <button
            onClick={handleZoomOut}
            className="w-8 h-8 flex items-center justify-center bg-white rounded-full border border-slate-200 text-slate-700 hover:bg-slate-50 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-700" data-oid="4p_8uep">

            <span className="text-lg" data-oid="hg_ydyi">-</span>
          </button>
          <div className="text-sm text-slate-500 dark:text-slate-400" data-oid="2cnoy1m">
            {Math.round(zoomLevel * 100)}%
          </div>
          <button
            onClick={handleZoomIn}
            className="w-8 h-8 flex items-center justify-center bg-white rounded-full border border-slate-200 text-slate-700 hover:bg-slate-50 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-700" data-oid="m3tme.s">

            <span className="text-lg" data-oid="b84sozn">+</span>
          </button>
        </div>
      </div>
      
      {/* Concept Map Visualization */}
      <div className="relative overflow-hidden border border-slate-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-800 h-[500px]" data-oid="jy4bv0i">
        {/* SVG Canvas */}
        <div
          ref={canvasRef}
          ...
          <svg width="100%" height="100%" viewBox="0 0 800 500" preserveAspectRatio="xMidYMid meet" data-oid="czr9i5n">
            {/* Links */}
            <g data-oid="imnej9n">
              {links.map((link, i) =>
              <line
                ...
                strokeDasharray={link.type === 'topic-topic' ? "5,5" : ""} data-oid="g6.ssar" />
            ...
            <g
              ...
              className="cursor-pointer" data-oid="6nw8l.8">

                <circle
                r={node.radius}
                className={`${getNodeColor(node)} border transition-all ${getSelectedClass(node)}`} data-oid="_89xeb6" />

                <text
                textAnchor="middle"
                dy=".3em"
                className="text-xs font-medium fill-slate-700 dark:fill-slate-200 pointer-events-none" data-oid="rm8jtky">
            ...
            <g
              ...
              className="cursor-pointer" data-oid="tp5s1vj">

                <circle
                r={node.radius}
                className={`${getNodeColor(node)} border transition-all ${getSelectedClass(node)}`} data-oid="ccxocn4" />

                <text
                textAnchor="middle"
                dy=".3em"
                className="text-xs fill-slate-700 dark:fill-slate-200 pointer-events-none" data-oid="xehiqa_">
        ...
        {/* Legend */}
        <div className="absolute bottom-3 left-3 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-2 rounded-md text-xs border border-slate-200 dark:border-slate-700" data-oid="_0:gg4k">
          <div className="font-medium mb-1" data-oid="fzta:j1">Legend</div>
          <div className="flex items-center mb-1" data-oid="bmrgsfw">
            <div className="w-3 h-3 rounded-full bg-indigo-100 border border-indigo-300 mr-1" data-oid="g8cwk9f"></div>
            <span data-oid="4n5p0ou">Topic nodes</span>
          </div>
          <div className="flex items-center mb-1" data-oid="vg_48o6">
            <div className="w-3 h-3 rounded-full bg-teal-100 border border-teal-300 mr-1" data-oid="vrh6cdd"></div>
            <span data-oid="l00u9kt">Subtopic nodes</span>
          </div>
          <div className="flex items-center" data-oid="r9y7cb0">
            <svg width="16" height="8" data-oid="95xjlfv">
              <line x1="0" y1="4" x2="16" y2="4" className="stroke-slate-300 dark:stroke-slate-600 stroke-[2]" data-oid="p5d2u_." />
            </svg>
            <span className="ml-1" data-oid="riy6jrm">Direct relations</span>
          </div>
          <div className="flex items-center" data-oid="gpnhe44">
            <svg width="16" height="8" data-oid="o5arssh">
              <line x1="0" y1="4" x2="16" y2="4" className="stroke-indigo-300 dark:stroke-indigo-700 stroke-[2] stroke-dasharray-[5,5]" data-oid=":bekaw2" />
            </svg>
            <span className="ml-1" data-oid="udk5c9c">Concept relations</span>
          </div>
        </div>
        
        {/* Instructions */}
        {!selectedTopic &&
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-3 rounded-md text-center border border-slate-200 dark:border-slate-700 shadow-lg" data-oid="fq:iooc">
            <div className="font-medium mb-1" data-oid="v6dcuij">Interactive Concept Map</div>
            <p className="text-sm text-slate-600 dark:text-slate-400" data-oid="i7lz5p5">
      ...
      {selectedTopic &&
      <div className="mt-4 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700" data-oid="0mhdyrt">
          <div className="flex justify-between items-center mb-3" data-oid="dnebd2f">
            <h4 className="font-semibold" data-oid="v0it2hg">{selectedTopic} Questions</h4>
            <button
            onClick={() => setSelectedTopic(null)}
            className="text-xs px-2 py-1 bg-white dark:bg-slate-700 rounded border border-slate-200 dark:border-slate-600" data-oid="o0.yrb4">

              Close
            </button>
          </div>
          
          <div className="space-y-2 max-h-[250px] overflow-y-auto" data-oid="rpyeu_r">
          ...
          <div
            ...
            'bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700/50'}`
                ...
                <div data-oid="t8nm0:n">
                  <div className="font-medium text-sm flex items-center" data-oid="l91acq8">
                    <span className={`inline-block w-2 h-2 rounded-full mr-2 ${
                question.correct ?
                'bg-green-500 dark:bg-green-400' :
                'bg-red-500 dark:bg-red-400'}`
                } data-oid="g76d.wr"></span>
                    {question.topic} - {question.subtopic}
                  </div>
                  <div className="text-xs text-slate-500 dark:text-slate-400" data-oid="2c6475g">
                    From {question.setType} • {question.setSubject}
                  </div>
                </div>
                <div className="text-right text-xs" data-oid="4-jv5pj">
          ...
          <div className="py-6 text-center text-slate-500 dark:text-slate-400" data-oid="z:iy4jt">
                <p data-oid="jyc9fdv">No questions available for this topic.</p>
              </div>
          }
          </div>
        </div>
