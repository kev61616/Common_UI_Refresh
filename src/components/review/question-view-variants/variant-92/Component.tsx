...
// Prehistoric cave art inspired concept mapping with primal symbols and ochre coloring
 ...
 */
export function CavePaintingConceptMapView({ practiceSets, onSelectSet, selectedSetId }: QuestionViewProps) {
  ...
  return (
    <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-4 shadow-sm" data-oid="pbf_t05">
      <h3 className="text-xl font-bold mb-6 text-center" data-oid="j6xwznh">92. Ancient Cave Painting Concept Map</h3>
      
      {/* Controls */}
      <div className="flex justify-between mb-6" data-oid="0-:.j-e">
        {/* Subject filter */}
        <div className="flex space-x-2" data-oid="ts:m96m">
          <button
        ...
        {/* Zoom controls */}
        <div className="flex items-center space-x-2" data-oid="kezh2g3">
          <button
            onClick={handleZoomOut}
            className="w-8 h-8 flex items-center justify-center bg-white rounded-full border border-slate-200 text-slate-700 hover:bg-slate-50 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-700" data-oid="hr-gwnf">

            <span className="text-lg" data-oid="xd8ma2_">-</span>
          </button>
          <div className="text-sm text-slate-500 dark:text-slate-400" data-oid="27tubyu">
            {Math.round(zoomLevel * 100)}%
          </div>
          <button
            onClick={handleZoomIn}
            className="w-8 h-8 flex items-center justify-center bg-white rounded-full border border-slate-200 text-slate-700 hover:bg-slate-50 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-700" data-oid="1mnkrst">

            <span className="text-lg" data-oid="s3j4er:">+</span>
          </button>
        </div>
      </div>
      
      {/* Concept Map Visualization */}
      <div className="relative overflow-hidden border border-slate-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-800 h-[500px]" data-oid=":im_0_c">
        {/* SVG Canvas */}
        <div
          ref={canvasRef}
          ...
          <svg width="100%" height="100%" viewBox="0 0 800 500" preserveAspectRatio="xMidYMid meet" data-oid="_1gogjv">
            {/* Links */}
            <g data-oid="i0ou6su">
              {links.map((link, i) =>
              <line
                ...
                strokeDasharray={link.type === 'topic-topic' ? "5,5" : ""} data-oid="m6.k7cb" />
            ...
            <g
              ...
              className="cursor-pointer" data-oid="wimxp9z">

                <circle
                r={node.radius}
                className={`${getNodeColor(node)} border transition-all ${getSelectedClass(node)}`} data-oid="nnu6d6w" />

                <text
                textAnchor="middle"
                dy=".3em"
                className="text-xs font-medium fill-slate-700 dark:fill-slate-200 pointer-events-none" data-oid=":x_x.v7">
            ...
            <g
              ...
              className="cursor-pointer" data-oid="us2bs-2">

                <circle
                r={node.radius}
                className={`${getNodeColor(node)} border transition-all ${getSelectedClass(node)}`} data-oid="8hrgv51" />

                <text
                textAnchor="middle"
                dy=".3em"
                className="text-xs fill-slate-700 dark:fill-slate-200 pointer-events-none" data-oid="f8u.r03">
        ...
        {/* Legend */}
        <div className="absolute bottom-3 left-3 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-2 rounded-md text-xs border border-slate-200 dark:border-slate-700" data-oid="pa7grre">
          <div className="font-medium mb-1" data-oid="9fkrqu2">Legend</div>
          <div className="flex items-center mb-1" data-oid="9h:x3u6">
            <div className="w-3 h-3 rounded-full bg-indigo-100 border border-indigo-300 mr-1" data-oid="h63psp."></div>
            <span data-oid="6nh9ugi">Topic nodes</span>
          </div>
          <div className="flex items-center mb-1" data-oid="-riwlpx">
            <div className="w-3 h-3 rounded-full bg-teal-100 border border-teal-300 mr-1" data-oid="hur465b"></div>
            <span data-oid="93jhh0a">Subtopic nodes</span>
          </div>
          <div className="flex items-center" data-oid="i.:efgi">
            <svg width="16" height="8" data-oid="suus9c0">
              <line x1="0" y1="4" x2="16" y2="4" className="stroke-slate-300 dark:stroke-slate-600 stroke-[2]" data-oid="21qigh2" />
            </svg>
            <span className="ml-1" data-oid="pixjpbz">Direct relations</span>
          </div>
          <div className="flex items-center" data-oid="51etk6-">
            <svg width="16" height="8" data-oid="w6rjzhm">
              <line x1="0" y1="4" x2="16" y2="4" className="stroke-indigo-300 dark:stroke-indigo-700 stroke-[2] stroke-dasharray-[5,5]" data-oid="bw72fd1" />
            </svg>
            <span className="ml-1" data-oid="7ujg11y">Concept relations</span>
          </div>
        </div>
        
        {/* Instructions */}
        {!selectedTopic &&
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-3 rounded-md text-center border border-slate-200 dark:border-slate-700 shadow-lg" data-oid="2i4f-.3">
            <div className="font-medium mb-1" data-oid="gy_lucf">Interactive Concept Map</div>
            <p className="text-sm text-slate-600 dark:text-slate-400" data-oid="atf29.c">
      ...
      {selectedTopic &&
      <div className="mt-4 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700" data-oid="b7fml7:">
          <div className="flex justify-between items-center mb-3" data-oid="yi1up5r">
            <h4 className="font-semibold" data-oid="owcdo.h">{selectedTopic} Questions</h4>
            <button
            onClick={() => setSelectedTopic(null)}
            className="text-xs px-2 py-1 bg-white dark:bg-slate-700 rounded border border-slate-200 dark:border-slate-600" data-oid="gwy9l.r">

              Close
            </button>
          </div>
          
          <div className="space-y-2 max-h-[250px] overflow-y-auto" data-oid="-stlta_">
          ...
          <div
            ...
            'bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700/50'}`
                ...
                <div data-oid="1mt9_pm">
                  <div className="font-medium text-sm flex items-center" data-oid="se60btp">
                    <span className={`inline-block w-2 h-2 rounded-full mr-2 ${
                question.correct ?
                'bg-green-500 dark:bg-green-400' :
                'bg-red-500 dark:bg-red-400'}`
                } data-oid="p.urmb:"></span>
                    {question.topic} - {question.subtopic}
                  </div>
                  <div className="text-xs text-slate-500 dark:text-slate-400" data-oid="it9xy0x">
                    From {question.setType} • {question.setSubject}
                  </div>
                </div>
                <div className="text-right text-xs" data-oid="2qyl8uo">
          ...
          <div className="py-6 text-center text-slate-500 dark:text-slate-400" data-oid="l0y11cs">
                <p data-oid="y75u-mn">No questions available for this topic.</p>
              </div>
          }
          </div>
        </div>
