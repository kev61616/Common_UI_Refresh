...
// Floating bubble visualization where tags exist in different sized spheres with animated movement
 ...
 */
export function BubbleFloatTagCloudView({ practiceSets, onSelectSet, selectedSetId }: QuestionViewProps) {
  ...
  return (
    <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-4 shadow-sm" data-oid=".8ti0gs">
      <h3 className="text-xl font-bold mb-6 text-center" data-oid=":-z6t7z">86. Bubble Float Tag Cloud</h3>
      
      {/* Controls */}
      <div className="flex justify-between mb-6" data-oid="76kam:l">
        <div className="flex space-x-2" data-oid="0cwvtrw">
          <button
        ...
        <div className="flex items-center space-x-4" data-oid="dc98okl">
          <div className="flex space-x-1 items-center" data-oid="2fqq2.3">
            <span className="text-xs text-slate-500 dark:text-slate-400" data-oid="i9u8.5b">Size:</span>
            <input
              type="range"
              min="8"
              max="40"
              ...
              className="w-20" data-oid="io5mr8y" />
      ...
      {/* Tag Cloud */}
      <div className="min-h-[300px] bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 p-8 flex flex-wrap justify-center items-center content-center gap-3 gap-y-6" data-oid=".hbh_cz">
        ...
        <div
          ...
          style={{
            ...
            <span className={getAccuracyColor(accuracy)} data-oid="67msi0f">{tag}</span>
            <span className="text-[10px] text-slate-400 ml-1 align-top" data-oid="ik248yx">
              {count}
            </span>
          </div>
        )}
        ...
        {tagData.length === 0 &&
        <div className="text-slate-500 dark:text-slate-400 text-center p-12" data-oid="bg52sdl">
      ...
      {/* Selected Tag Info */}
      {selectedTag &&
      <div className="mt-6 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700" data-oid="qpe.2_6">
          <div className="flex justify-between items-center mb-3" data-oid="xm8m2do">
            <h4 className="font-semibold" data-oid="opy221.">
              Questions with{' '}
            ...
            className="text-xs px-2 py-1 bg-white dark:bg-slate-700 rounded border border-slate-200 dark:border-slate-600" data-oid="y45:1jt">

              Close
            </button>
          </div>
          
          <div className="space-y-2 max-h-[250px] overflow-y-auto" data-oid="inhykx.">
          ...
          <div
            ...
            'bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700/50'}`
                ...
                <div data-oid="hg28l4:">
                  <div className="font-medium text-sm flex items-center" data-oid="ja5o_q3">
                    <span className={`inline-block w-2 h-2 rounded-full mr-2 ${
                question.correct ?
                'bg-green-500 dark:bg-green-400' :
                'bg-red-500 dark:bg-red-400'}`
                } data-oid="4jz3sl3"></span>
                    {question.topic} - {question.subtopic}
                  </div>
                  <div className="text-xs text-slate-500 dark:text-slate-400" data-oid="gvk829e">
                    From {question.setType} • {question.setSubject}
                  </div>
                </div>
                <div className="text-right text-xs" data-oid="0a42:i_">
          ...
          <div className="py-6 text-center text-slate-500 dark:text-slate-400" data-oid="qej9idm">
                <p data-oid="b-9u._x">No questions available for this tag.</p>
              </div>
          }
          </div>
        </div>
