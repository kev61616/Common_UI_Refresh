...
export function PeriodicTableOfKnowledgeView({ practiceSets, onSelectSet, selectedSetId }: QuestionViewProps) {
  ...
  return (
    <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-4 shadow-sm">
      <h3 className="text-xl font-bold mb-6 text-center">63. Periodic Table of Knowledge</h3>
        ...
        <table className="w-full border-collapse">
          ...
          <tbody>
                ...
                <td className="p-3 text-center border-b dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50">
                  ...
                  <div className="w-full bg-slate-200 dark:bg-slate-700 h-1 mt-1 rounded-full overflow-hidden">
                    <div 
                      ...
                      style={{ width: `${topicTotals.find(t => t.topic === row.topic)?.accuracy || 0}%` }}
                    ></div>
                  </div>
                </td>
              </tr>
            ...
            <tr>
              ...
              <td className="p-3 text-center border-b dark:border-slate-700 bg-indigo-50 dark:bg-indigo-900/20">
