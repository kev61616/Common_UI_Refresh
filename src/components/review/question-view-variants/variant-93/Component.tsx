...
export function Component({ practiceSets, selectedSetId, onSelectSet }: QuestionViewProps) {
  ...
  return (
    <div className="p-6 bg-gray-50 dark:bg-gray-900 rounded-lg shadow-md h-full min-h-[600px] overflow-hidden">
      ...
      <div className="relative bg-white dark:bg-gray-800 rounded-lg p-4 h-[500px] overflow-hidden">
      ...
      <div className="mt-4 text-sm text-gray-600 dark:text-gray-400">
        <p>Click on neurons to activate them and see connections. The network visualizes relationships between questions based on topics.</p>
        <p className="mt-1">
