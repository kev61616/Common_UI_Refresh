...
// Quantum physics inspired concept visualization with probability fields and energy states
 ...
 */
export function QuantumFieldConceptMapView({ practiceSets, onSelectSet, selectedSetId }: QuestionViewProps) {
  ...
  return (
    <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-4 shadow-sm" data-oid="bb_k8gu">
      <h3 className="text-xl font-bold mb-6 text-center" data-oid="f7i56li">90. Quantum Field Concept Map</h3>
      
      {/* Controls */}
      <div className="flex justify-between mb-6" data-oid="okl3-vi">
        {/* Subject filter */}
        <div className="flex space-x-2" data-oid="vb5sif4">
          <button
        ...
        {/* Zoom controls */}
        <div className="flex items-center space-x-2" data-oid="0pu2:w1">
          <button
            onClick={handleZoomOut}
            className="w-8 h-8 flex items-center justify-center bg-white rounded-full border border-slate-200 text-slate-700 hover:bg-slate-50 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-700" data-oid="l0np2uu">

            <span className="text-lg" data-oid="0wyisrv">-</span>
          </button>
          <div className="text-sm text-slate-500 dark:text-slate-400" data-oid="kzd9o2w">
            {Math.round(zoomLevel * 100)}%
          </div>
          <button
            onClick={handleZoomIn}
            className="w-8 h-8 flex items-center justify-center bg-white rounded-full border border-slate-200 text-slate-700 hover:bg-slate-50 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-700" data-oid="f9v3nda">

            <span className="text-lg" data-oid="ml3ve:r">+</span>
          </button>
        </div>
      </div>
      
      {/* Concept Map Visualization */}
      <div className="relative overflow-hidden border border-slate-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-800 h-[500px]" data-oid="2_._ivx">
        {/* SVG Canvas */}
        <div
          ref={canvasRef}
          ...
          <svg width="100%" height="100%" viewBox="0 0 800 500" preserveAspectRatio="xMidYMid meet" data-oid="v0v1jvg">
            {/* Links */}
            <g data-oid="0-ber8r">
              {links.map((link, i) =>
              <line
                ...
                strokeDasharray={link.type === 'topic-topic' ? "5,5" : ""} data-oid="x8qt31c" />
            ...
            <g
              ...
              className="cursor-pointer" data-oid="02e.qs1">

                <circle
                r={node.radius}
                className={`${getNodeColor(node)} border transition-all ${getSelectedClass(node)}`} data-oid="n_nirdy" />

                <text
                textAnchor="middle"
                dy=".3em"
                className="text-xs font-medium fill-slate-700 dark:fill-slate-200 pointer-events-none" data-oid="gyiorkc">
            ...
            <g
              ...
              className="cursor-pointer" data-oid="70u0y1h">

                <circle
                r={node.radius}
                className={`${getNodeColor(node)} border transition-all ${getSelectedClass(node)}`} data-oid="0hkenk." />

                <text
                textAnchor="middle"
                dy=".3em"
                className="text-xs fill-slate-700 dark:fill-slate-200 pointer-events-none" data-oid="2cusa-g">
        ...
        {/* Legend */}
        <div className="absolute bottom-3 left-3 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-2 rounded-md text-xs border border-slate-200 dark:border-slate-700" data-oid="drge1.9">
          <div className="font-medium mb-1" data-oid="qbjlb8u">Legend</div>
          <div className="flex items-center mb-1" data-oid="yho.c68">
            <div className="w-3 h-3 rounded-full bg-indigo-100 border border-indigo-300 mr-1" data-oid="f9ak6g6"></div>
            <span data-oid="wmbwcfd">Topic nodes</span>
          </div>
          <div className="flex items-center mb-1" data-oid="bw-q-wt">
            <div className="w-3 h-3 rounded-full bg-teal-100 border border-teal-300 mr-1" data-oid="9t3bfjv"></div>
            <span data-oid="yoxpw34">Subtopic nodes</span>
          </div>
          <div className="flex items-center" data-oid="xv9xemz">
            <svg width="16" height="8" data-oid="js2vk1l">
              <line x1="0" y1="4" x2="16" y2="4" className="stroke-slate-300 dark:stroke-slate-600 stroke-[2]" data-oid="xemr7_e" />
            </svg>
            <span className="ml-1" data-oid="xs6:aew">Direct relations</span>
          </div>
          <div className="flex items-center" data-oid="p872x:z">
            <svg width="16" height="8" data-oid="8bbrh01">
              <line x1="0" y1="4" x2="16" y2="4" className="stroke-indigo-300 dark:stroke-indigo-700 stroke-[2] stroke-dasharray-[5,5]" data-oid="1q2vjff" />
            </svg>
            <span className="ml-1" data-oid="6r7:s-c">Concept relations</span>
          </div>
        </div>
        
        {/* Instructions */}
        {!selectedTopic &&
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-3 rounded-md text-center border border-slate-200 dark:border-slate-700 shadow-lg" data-oid="hsd6gep">
            <div className="font-medium mb-1" data-oid="cvci571">Interactive Concept Map</div>
            <p className="text-sm text-slate-600 dark:text-slate-400" data-oid="m.:4kyc">
      ...
      {selectedTopic &&
      <div className="mt-4 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700" data-oid="md4vktv">
          <div className="flex justify-between items-center mb-3" data-oid="3-q:su-">
            <h4 className="font-semibold" data-oid="-y5rz.7">{selectedTopic} Questions</h4>
            <button
            onClick={() => setSelectedTopic(null)}
            className="text-xs px-2 py-1 bg-white dark:bg-slate-700 rounded border border-slate-200 dark:border-slate-600" data-oid="8v22p9a">

              Close
            </button>
          </div>
          
          <div className="space-y-2 max-h-[250px] overflow-y-auto" data-oid="1exsl7x">
          ...
          <div
            ...
            'bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700/50'}`
                ...
                <div data-oid="ogaheyr">
                  <div className="font-medium text-sm flex items-center" data-oid="u2hbhfn">
                    <span className={`inline-block w-2 h-2 rounded-full mr-2 ${
                question.correct ?
                'bg-green-500 dark:bg-green-400' :
                'bg-red-500 dark:bg-red-400'}`
                } data-oid="bwtd6oa"></span>
                    {question.topic} - {question.subtopic}
                  </div>
                  <div className="text-xs text-slate-500 dark:text-slate-400" data-oid="bh.sew1">
                    From {question.setType} • {question.setSubject}
                  </div>
                </div>
                <div className="text-right text-xs" data-oid="be1-tui">
          ...
          <div className="py-6 text-center text-slate-500 dark:text-slate-400" data-oid="alvpk1_">
                <p data-oid="72jnda_">No questions available for this topic.</p>
              </div>
          }
          </div>
        </div>
