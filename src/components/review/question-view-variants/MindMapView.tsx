...
export function MindMapView({ practiceSets, onSelectSet, selectedSetId }: QuestionViewProps) {
  ...
  return (
    <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-4 shadow-sm" data-oid="jhadok3">
      <h3 className="text-xl font-bold mb-6 text-center" data-oid="65332.s">24. Mind Map View</h3>
      
      <div className="bg-slate-900 dark:bg-slate-950 rounded-lg p-4 relative min-h-[500px] mb-4" data-oid="f5813z6">
        <canvas
          ref={canvasRef}
          className="w-full h-full"
          style={{ height: '500px' }} data-oid="wk0_8qr">
        </canvas>
        ...
        <button
          ...
          onClick={() => setCenterNode(null)} data-oid="9dgy3zt">

            <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-oid="lwrdbss">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" data-oid="b50m9jk"></path>
            </svg>
            Back to Full View
          </button>
        }
      ...
      <div className="bg-white dark:bg-slate-800 p-3 rounded-md text-sm" data-oid="3_:zslj">
        <div className="mb-3" data-oid=":d0uku4">
          <h4 className="font-medium mb-2 text-slate-700 dark:text-slate-300" data-oid="tdf8qiv">Interaction Guide:</h4>
          <ul className="text-slate-600 dark:text-slate-400 text-xs space-y-1 ml-4 list-disc" data-oid="b9sagfo">
            <li data-oid="2voa8sf">Click on nodes to select questions or expand/collapse branches</li>
            <li data-oid="wgf8hly">Double-click on a node to focus on that branch</li>
            <li data-oid="x_1nyuy">Click the small circle on nodes to expand/collapse</li>
            <li data-oid="68gz:mp">Click "Back to Full View" to return to the complete mind map</li>
          </ul>
        </div>
        
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-xs" data-oid="95tw:fq">
          <div className="flex items-center gap-2" data-oid="uyed069">
            <div className="w-4 h-4 rounded-full bg-indigo-500" data-oid="wjkabul"></div>
            <span className="text-slate-600 dark:text-slate-400" data-oid="..ra-es">Root</span>
          </div>
          <div className="flex items-center gap-2" data-oid="ih2r64v">
            <div className="w-4 h-4 rounded-full bg-violet-500" data-oid="_x:v4sn"></div>
            <span className="text-slate-600 dark:text-slate-400" data-oid="hdg12f.">Subject</span>
          </div>
          <div className="flex items-center gap-2" data-oid="eu0.1:t">
            <div className="w-4 h-4 rounded-full bg-purple-500" data-oid="zz7ld6s"></div>
            <span className="text-slate-600 dark:text-slate-400" data-oid="2exzxkl">Topic</span>
          </div>
          <div className="flex items-center gap-2" data-oid="75dhs:y">
            <div className="w-4 h-4 rounded-full bg-fuchsia-500" data-oid="3my7m6j"></div>
            <span className="text-slate-600 dark:text-slate-400" data-oid="k_:gvka">Subtopic</span>
          </div>
          <div className="flex items-center gap-2" data-oid="e7vkzs.">
            <div className="w-4 h-4 rounded-full bg-green-500" data-oid="_84mbw8"></div>
            <span className="text-slate-600 dark:text-slate-400" data-oid="oqlfdxw">High Accuracy</span>
          </div>
          <div className="flex items-center gap-2" data-oid="4yh.v8u">
            <div className="w-4 h-4 rounded-full bg-red-500" data-oid="39w9w11"></div>
            <span className="text-slate-600 dark:text-slate-400" data-oid="h.u_bdl">Low Accuracy</span>
          </div>
        </div>
      </div>
    </div>);
