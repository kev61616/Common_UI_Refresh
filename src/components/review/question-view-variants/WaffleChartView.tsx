...
export function WaffleChartView({ practiceSets, onSelectSet, selectedSetId }: QuestionViewProps) {
  ...
  return (
    <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-4 shadow-sm">
      <h3 className="text-xl font-bold mb-6 text-center">36. Waffle Chart View</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
        ...
        <div>
          {selectedCategory && selectedQuestions.length > 0 ? (
            ...
            <div className="p-8 bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 flex items-center justify-center">
              <p className="text-slate-500 dark:text-slate-400 text-center">
                Select a category from the waffle chart<br />to view detailed information
              </p>
            </div>
          )}
        </div>
