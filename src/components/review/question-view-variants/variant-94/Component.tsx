...
export function Component({ practiceSets, selectedSetId, onSelectSet }: QuestionViewProps) {
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold mb-4 text-gray-800 dark:text-white z-10 relative">
        3D Cube View
      </h2>
      
      <div className="flex mb-4 space-x-2 z-10 relative">
      ...
      <div className="relative h-[500px] overflow-hidden bg-white dark:bg-gray-800 rounded-lg">
        ...
        {/* Controls and Info */}
        <div className="absolute bottom-4 left-4 bg-white dark:bg-gray-700 p-2 rounded shadow z-10">
          ...
          <div className="text-xs mt-2">
            ...
            <p>Click a cube to rotate it</p>
          </div>
        </div>
        
        {/* Selected question details */}
        {selectedCube && (
          <div className="absolute top-4 right-4 bg-white dark:bg-gray-700 p-3 rounded shadow max-w-xs z-10">
            ...
            {(() => {
              ...
              return (
                <div className="text-xs mt-1">
                  <p><span className="font-medium">Topic:</span> {cube.topic}</p>
                  <p><span className="font-medium">Subtopic:</span> {cube.subtopic}</p>
                  <p><span className="font-medium">Difficulty:</span> {cube.difficulty}</p>
                  <p><span className="font-medium">Time spent:</span> {cube.timeSpent}s</p>
                  <p><span className="font-medium">Result:</span> {cube.correct ? 'Correct' : 'Incorrect'}</p>
                </div>
              )
            })()}
            <button 
