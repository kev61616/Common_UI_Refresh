...
export function SatelliteThermalMapView({ practiceSets, onSelectSet, selectedSetId }: QuestionViewProps) {
  ...
  return (
    <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-4 shadow-sm">
      <h3 className="text-xl font-bold mb-6 text-center">55. Satellite Thermal Map</h3>
              ...
              <div key={row.topic} className="flex">
                ...
                <div className="w-36 py-2 pr-3 text-right text-sm truncate flex items-center justify-end">
                  <div>
                    ...
                    <div className="text-xs text-slate-500 dark:text-slate-400">{row.totalCount} questions</div>
                  </div>
                </div>
                ...
                <div className="flex-1 grid grid-cols-3 gap-2">
                  {row.cells.map(cell => (
                    <div 
                      ...
                      onClick={() => selectCell(cell.topic, cell.difficulty)}
                    >
                      {cell.count > 0 ? (
                        <>
      ...
      {selectedDimension && selectedQuestions.length > 0 && (
        <div className="mt-8 p-4 bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 max-w-3xl mx-auto">
