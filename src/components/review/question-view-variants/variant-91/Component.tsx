...
// Surrealist dream-inspired fluid concept mapping with morphing connections and transitions
 ...
 */
export function DreamscapeConceptMapView({ practiceSets, onSelectSet, selectedSetId }: QuestionViewProps) {
  ...
  return (
    <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-4 shadow-sm" data-oid="b7:hrb0">
      <h3 className="text-xl font-bold mb-6 text-center" data-oid=".jfsypo">91. Dreamscape Concept Map</h3>
      
      {/* Controls */}
      <div className="flex justify-between mb-6" data-oid="l2ed_3x">
        {/* Subject filter */}
        <div className="flex space-x-2" data-oid="t6sq.qi">
          <button
        ...
        {/* Zoom controls */}
        <div className="flex items-center space-x-2" data-oid="ly64_ad">
          <button
            onClick={handleZoomOut}
            className="w-8 h-8 flex items-center justify-center bg-white rounded-full border border-slate-200 text-slate-700 hover:bg-slate-50 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-700" data-oid="zbjh4o5">

            <span className="text-lg" data-oid="uxfaplq">-</span>
          </button>
          <div className="text-sm text-slate-500 dark:text-slate-400" data-oid="tmsary5">
            {Math.round(zoomLevel * 100)}%
          </div>
          <button
            onClick={handleZoomIn}
            className="w-8 h-8 flex items-center justify-center bg-white rounded-full border border-slate-200 text-slate-700 hover:bg-slate-50 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-700" data-oid="26xbk0u">

            <span className="text-lg" data-oid=".wd-e2v">+</span>
          </button>
        </div>
      </div>
      
      {/* Concept Map Visualization */}
      <div className="relative overflow-hidden border border-slate-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-800 h-[500px]" data-oid="jn3ws05">
        {/* SVG Canvas */}
        <div
          ref={canvasRef}
          ...
          <svg width="100%" height="100%" viewBox="0 0 800 500" preserveAspectRatio="xMidYMid meet" data-oid="jk01-xu">
            {/* Links */}
            <g data-oid="f8_7jf0">
              {links.map((link, i) =>
              <line
                ...
                strokeDasharray={link.type === 'topic-topic' ? "5,5" : ""} data-oid="nndly10" />
            ...
            <g
              ...
              className="cursor-pointer" data-oid="0u5qrnr">

                <circle
                r={node.radius}
                className={`${getNodeColor(node)} border transition-all ${getSelectedClass(node)}`} data-oid="7wzwhy6" />

                <text
                textAnchor="middle"
                dy=".3em"
                className="text-xs font-medium fill-slate-700 dark:fill-slate-200 pointer-events-none" data-oid="zkaq.-z">
            ...
            <g
              ...
              className="cursor-pointer" data-oid="9zrd37a">

                <circle
                r={node.radius}
                className={`${getNodeColor(node)} border transition-all ${getSelectedClass(node)}`} data-oid="xsxvl-m" />

                <text
                textAnchor="middle"
                dy=".3em"
                className="text-xs fill-slate-700 dark:fill-slate-200 pointer-events-none" data-oid="34vjq7:">
        ...
        {/* Legend */}
        <div className="absolute bottom-3 left-3 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-2 rounded-md text-xs border border-slate-200 dark:border-slate-700" data-oid="kjqne6b">
          <div className="font-medium mb-1" data-oid="0bxzi9_">Legend</div>
          <div className="flex items-center mb-1" data-oid="av7ka45">
            <div className="w-3 h-3 rounded-full bg-indigo-100 border border-indigo-300 mr-1" data-oid="nxargk6"></div>
            <span data-oid="lxqt.9s">Topic nodes</span>
          </div>
          <div className="flex items-center mb-1" data-oid="oh42lev">
            <div className="w-3 h-3 rounded-full bg-teal-100 border border-teal-300 mr-1" data-oid="l9jq5uy"></div>
            <span data-oid="_102ek_">Subtopic nodes</span>
          </div>
          <div className="flex items-center" data-oid="nicn6_r">
            <svg width="16" height="8" data-oid="nk13l19">
              <line x1="0" y1="4" x2="16" y2="4" className="stroke-slate-300 dark:stroke-slate-600 stroke-[2]" data-oid="7.jzlny" />
            </svg>
            <span className="ml-1" data-oid="-4vjazu">Direct relations</span>
          </div>
          <div className="flex items-center" data-oid="_j09ind">
            <svg width="16" height="8" data-oid="u732vbx">
              <line x1="0" y1="4" x2="16" y2="4" className="stroke-indigo-300 dark:stroke-indigo-700 stroke-[2] stroke-dasharray-[5,5]" data-oid="auzbrmn" />
            </svg>
            <span className="ml-1" data-oid="7u7q.xm">Concept relations</span>
          </div>
        </div>
        
        {/* Instructions */}
        {!selectedTopic &&
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-3 rounded-md text-center border border-slate-200 dark:border-slate-700 shadow-lg" data-oid="kxcm97h">
            <div className="font-medium mb-1" data-oid="u9:az:f">Interactive Concept Map</div>
            <p className="text-sm text-slate-600 dark:text-slate-400" data-oid="7qsc5-l">
      ...
      {selectedTopic &&
      <div className="mt-4 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700" data-oid="se.qfoq">
          <div className="flex justify-between items-center mb-3" data-oid=":t:t42.">
            <h4 className="font-semibold" data-oid="280a8l2">{selectedTopic} Questions</h4>
            <button
            onClick={() => setSelectedTopic(null)}
            className="text-xs px-2 py-1 bg-white dark:bg-slate-700 rounded border border-slate-200 dark:border-slate-600" data-oid="uf4d68j">

              Close
            </button>
          </div>
          
          <div className="space-y-2 max-h-[250px] overflow-y-auto" data-oid="ly0bgeq">
          ...
          <div
            ...
            'bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700/50'}`
                ...
                <div data-oid="z.off4u">
                  <div className="font-medium text-sm flex items-center" data-oid="xl-d_zx">
                    <span className={`inline-block w-2 h-2 rounded-full mr-2 ${
                question.correct ?
                'bg-green-500 dark:bg-green-400' :
                'bg-red-500 dark:bg-red-400'}`
                } data-oid=":t847v9"></span>
                    {question.topic} - {question.subtopic}
                  </div>
                  <div className="text-xs text-slate-500 dark:text-slate-400" data-oid="727ez4j">
                    From {question.setType} • {question.setSubject}
                  </div>
                </div>
                <div className="text-right text-xs" data-oid="smu.d5s">
          ...
          <div className="py-6 text-center text-slate-500 dark:text-slate-400" data-oid="b4vluth">
                <p data-oid="0og67q9">No questions available for this topic.</p>
              </div>
          }
          </div>
        </div>
