...
export function ThreeDTimeline({ practiceSets, onSelectSet, selectedSetId }: TimelineViewProps) {
  ...
  return (
    <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-4 shadow-sm" data-oid="wfi_z6b">
      <h3 className="text-xl font-bold mb-6 text-center" data-oid="n-3712p">7. 3D Timeline View</h3>
      
      <div className="min-h-[600px] perspective-[1000px] overflow-x-auto py-10" data-oid="g0nv4jr">
        <div className="min-w-[800px] h-[500px] relative transform-style-preserve-3d transform rotate-x-[15deg]" data-oid="bg:bhbc">
          {/* 3D Ground plane */}
          <div className="absolute inset-0 bg-gradient-to-b from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-900 transform rotate-x-[90deg] translate-z-[-100px] origin-bottom" data-oid="q3fv-pz"></div>
          
          {/* Time axis */}
          <div className="absolute left-[10%] right-[10%] h-1 bg-indigo-500 top-3/4 transform translate-z-[-20px]" data-oid="4cp0:y:"></div>
          ...
          {sortedSets.map((set, index) => {
            ...
            return (
              <div key={set.id} className="absolute" style={{ left: `${position}%`, bottom: '25%' }} data-oid="iwqe:yj">
                {/* Vertical line */}
                <div
                ...
                <div
                  ...
                  style={{ transform: `translateZ(${zPos}px)` }} data-oid="e-ml.bx">
                </div>
                ...
                <div
                  ...
                  <div className="flex justify-between items-center mb-2" data-oid="mv7ss8f">
                    ...
                    <div className="text-xs text-slate-500 dark:text-slate-400" data-oid="amkvd27">
                      {new Date(set.dateCompleted).toLocaleDateString()}
                    </div>
                  </div>
                  
                  <div className="font-bold truncate" data-oid="z-yuj7t">{set.type}</div>
                  
                  <div className="mt-2 flex justify-between" data-oid="yywhx-x">
                    <div className="text-lg font-bold" data-oid="-f33lrf">
                      {set.accuracy}%
                    </div>
                    <div className="text-sm text-slate-500 dark:text-slate-400" data-oid="c3lm5hj">
                ...
                <div
                  ...
                  style={{ transform: `translateZ(${zPos}px)` }} data-oid="81h-hz6">
          ...
          style={{ transform: 'translateZ(-20px)' }} data-oid="-dsyd98"></div>
          <div className="absolute right-[10%] w-0.5 h-40 bg-slate-300 dark:bg-slate-700 bottom-1/4 transform-style-preserve-3d"
          style={{ transform: 'translateZ(-20px)' }} data-oid="5td8dd4"></div>
        </div>
      </div>
      
      <div className="text-center text-sm text-slate-500 dark:text-slate-400 mt-4" data-oid="0lr0e8_">
