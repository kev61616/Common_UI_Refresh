...
export function CircularTimeline({ practiceSets, onSelectSet, selectedSetId }: TimelineViewProps) {
  return (
    <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-4 shadow-sm">
      <h3 className="text-xl font-bold mb-6 text-center">6. Circular Timeline</h3>
      ...
      <div className="relative flex justify-center min-h-[600px]">
        ...
        <div className="relative w-[500px] h-[500px] mt-6">
          ...
          {/* Center point */}
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-indigo-500 text-white font-bold flex items-center justify-center shadow-lg z-20">
            Now
          </div>
