      ...
      <div className="space-y-8">
        {Object.entries(setsByDifficulty).map(([difficulty, sets]) => (
          <div key={difficulty} className="space-y-4">
            <h3 className="text-lg font-medium text-gray-700 dark:text-gray-200 border-b border-gray-200 dark:border-gray-700 pb-2">
              {difficulty} Crystals
            </h3>
              ...
              {sets.map(set => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Data metrics */}
                    <div className="grid grid-cols-2 gap-2 mt-3 pt-3 border-t border-gray-200 dark:border-gray-700 text-sm">
                      <div>
                        <div className="text-gray-500 dark:text-gray-400 text-xs">Questions</div>
                        <div className="font-medium">{set.questions.length}</div>
                      </div>
                      <div>
                        <div className="text-gray-500 dark:text-gray-400 text-xs">Time Spent</div>
                        <div className="font-medium">{Math.floor(set.timeUsed / 60)}m</div>
                      </div>
                      <div>
                        <div className="text-gray-500 dark:text-gray-400 text-xs">Conceptual Errors</div>
                        <div className="font-medium">{set.mistakeTypes.conceptual}</div>
                      </div>
                      <div>
                        <div className="text-gray-500 dark:text-gray-400 text-xs">Careless Errors</div>
